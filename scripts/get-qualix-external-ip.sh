...
export qualix_outbound_ip=$(kubectl exec -i -n svetak $POD_NAME -c guacamole -- sh -c "curl icanhazip.com")
kubectl exec -i -n svetak $POD_NAME -c guacamole -- sh -c "touch /disableValidateLink"
echo $qualix_ip
